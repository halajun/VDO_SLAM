...
public:
    ...
    inline const ImagePacket& Images() const { return images; }
    inline const Features& StaticFeatures() const { return static_features; }
    inline const Features& DynamicFeatures() const { return dynamic_features; }
