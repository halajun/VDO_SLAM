...
private:
  ...
  KeyToFeatureMap static_feature_slots_; //all keys here should be in the isam graph and correlate to a staitc lmk being optimzised
  TrackletsMap unadded_static_tracklets_; //map of tracklets and used to update the map. the length should correspond to the features age
