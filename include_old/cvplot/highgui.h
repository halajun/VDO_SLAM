...
Rect selectROI(const std::string& windowName, void* img, bool showCrosshair = true, bool fromCenter = false);
Rect selectROI(void* img, bool showCrosshair = true, bool fromCenter = false);
void selectROIs(const std::string& windowName, void* img, std::vector<Rect>& boundingBoxes, bool showCrosshair = true,
                bool fromCenter = false);
void setMouseCallback(const std::string& view, MouseCallback onMouse, void* userdata = 0);
