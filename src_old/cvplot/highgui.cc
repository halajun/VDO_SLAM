...
namespace cvplot
{
int createTrackbar(const std::string& trackbarname, const std::string& winname, int* value, int count,
...
Rect selectROI(const std::string& windowName, void* img, bool showCrosshair, bool fromCenter)
{
  // TODO
#if CV_MAJOR_VERSION > 2
...
void selectROIs(const std::string& windowName, void* img, std::vector<Rect>& boundingBoxes, bool showCrosshair,
                bool fromCenter)
{
  // TODO
#if CV_MAJOR_VERSION > 2
  ...
  cv::selectROIs(windowName, (cv::InputArray)img, boxes, showCrosshair, fromCenter);
#endif
}

void setMouseCallback(const std::string& view, MouseCallback onMouse, void* userdata)
{
